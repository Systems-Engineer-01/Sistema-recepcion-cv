                    ...
                    <tr key={log.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="p-3.5 font-semibold text-slate-900 whitespace-nowrap">
                        {log.dni ? (
                          ...
                          <span className="text-slate-400 italic">Anónimo / Sistema</span>
                        )}
                      </td>

                      <td className="p-3.5">
                        <div className="font-mono font-medium text-slate-900">{log.ip}</div>
                      ...
                      <td className="p-3.5 whitespace-nowrap">
                        ...
                        >
                          {isBlock && <AlertTriangle className="w-3 h-3 text-rose-600" />}
                          {isSuccess && <FileCheck className="w-3 h-3 text-emerald-600" />}
                          <span>{log.accion}</span>
                        </span>
                      </td>

                      <td className="p-3.5 pr-6 max-w-xs truncate text-slate-600" title={log.detalles}>
                        {log.detalles || '-'}
                      </td>
                    </tr>
                  );
        ...
        {totalPages > 1 && (
          <div className="p-4 bg-slate-50 border-t border-slate-200 flex justify-between items-center text-xs">
            <button
              ...
              className="px-3 py-1.5 border border-slate-300 rounded-lg disabled:opacity-40 font-semibold bg-white"
            >
              Anterior
            </button>
